...
const jpHistoryLead = (
  <>
    Tally Groupは2021年、クラウド請求ソリューションのリーディングプロバイダーであるAgility CISと、成長著しいエネルギー小売向けSaaSプロバイダーであるタリーの合併により誕生しました。2026年にはエネルギーコンサルティング会社
    <a
...
const japanLeaders = [
  {
    name: "ピーター ウェイガンド",
    role: "最高事業成長責任者（CGO）",
    bio: "Tally Groupの最高事業成長責任者（CGO）として、米国および日本市場における事業拡大を統括。Tally参画以前には、エネルギー関連企業4社でCEOを歴任し、複数のエネルギースタートアップ企業で取締役を務めるなど、グローバルなエネルギー業界において豊富な経営経験を有する。現在は、Tally Group傘下のエネルギーコンサルティング会社であるスキッピングストーンのCEOも兼任。コンサルティングサービスとタリーの先進的なソリューションを組み合わせたパートナーシップの構築を通じ、タリーのグローバル成長を推進している。",
  ...
  },
  {
    name: "坂本 泉",
    role: "プリセールス・製品戦略担当",
    bio: "Tally Group日本市場におけるプリセールスおよび製品戦略を担当。10年以上にわたり、電力・ガス自由化、法的分離、発送電分離関連ソリューション領域において、ビジネス開発からサービス提供まで幅広く従事。大手ソフトウェアベンダーで培った、多岐にわたるソリューションに関する豊富な知見を有する。直近では、大手小売事業者向けプロジェクトにおいて、オーストラリアおよびインドのチームと連携し、プロジェクトの立て直しから運用定着化までを推進。これまでの顧客支援経験を活かし、日本市場での展開を推進している。",
...
const leaders = [
  {
    name: "アンドリュー・ダンカン",
    role: "最高経営責任者（CEO）",
    bio: "タリーの創業者兼会長で、2022年のTally Group設立に伴う統合後、CEOに就任。30年以上にわたりオーストラリアのエネルギー業界に携わり、テクノロジーを活用し、小売エネルギー分野の変革をリードしてきた。サービスワークスを創業し、2011年にはコンピュータシェアへの売却を成功させるとともに、オーストラリアの自由化エネルギー市場における初のBPOサービスプロバイダーを確立。創業者および投資家として豊富な実績を有し、業界に対する深い知見と、業務効率化および顧客価値向上を重視した実行力のあるリーダーシップを強みとしている。",
    photo: "Andrew.jpg",
  },
  {
    name: "トラビス・レーマン",
  ...
  },
  {
    name: "ジャネット・リー",
    role: "最高商務責任者（CCO）",
    bio: "テクノロジー分野において14年以上にわたり、事業戦略や成長戦略、企業価値向上に携わる。2025年にTally Groupの経営陣に参画。コンパス・エデュケーションおよびシーク・リミテッドでは上級管理職を歴任し、複数の市場をまたぐ事業環境の中で、グローバル展開、ポートフォリオマネジメント、M&Aを推進。PwCの監査部門からキャリアをスタートし、ビジネス全体を俯瞰する視点と、協調性を重視したリーダーシップスタイルを培う。事業の拡張性を高める仕組みづくりを通じてグローバル成長を支援し、顧客への持続的な価値提供に注力している。",
    photo: "Janet Le.jpg",
  },
  {
    name: "エリック・エルマズ",
    role: "最高技術責任者（CTO）",
    bio: "2023年にタリーに参画。20年以上にわたり、テクノロジー戦略、デジタルプラットフォーム、インフラ、オペレーション、製品開発領域に携わる。以前はソーテッドの最高技術責任者を務めたほか、EYにおいてイノベーションおよびテクノロジー領域の要職を歴任。現在は、クラウドアーキテクチャやAI活用を軸に、Tally Groupのグローバル技術戦略を統括し、高品質かつ将来を見据えたプラットフォーム構築と、強い組織づくりを推進している。",
    photo: "Eric Yilmaz.jpg",
  },
  {
    name: "ロジャー・バーンズ",
    role: "最高製品責任者（CPO）",
    bio: "15年以上にわたりエネルギー・公益業界に携わり、オーストラリア・ニュージーランド地域の統括責任者として地域事業の成長と製品機能の強化を推進。現在はTally Groupの最高製品責任者（CPO）として、テクノロジー、製品、市場環境の変化を踏まえたイノベーション推進に注力している。ビルキャップのCEO、タリーITおよびスリーブズアップの代表を歴任したほか、エネルギー、通信、サイバーセキュリティ分野において、製品開発およびサービス提供領域の幅広い要職を歴任。業務効率化と顧客価値向上の実現に向け、Tally Groupのグローバル製品戦略およびロードマップを統括している。",
      ...
      <section className="relative overflow-hidden pt-[120px] pb-[48px] lg:pt-[160px] lg:pb-[64px]" style={{
        ...
        <div className="max-w-[1240px] mx-auto px-8">
          ...
          <div className="mt-[20px] text-[20px] leading-[1.7] text-fg2 max-w-[60ch] flex flex-col gap-[16px]">
            <p className="m-0">
              Tally Groupは、ユーティリティ、エネルギー小売事業者、エネルギー転換関連事業者など、さまざまなエネルギー関連企業向けにソリューションを提供しています。
            </p>
            <p className="m-0">
          ...
          <div className="max-w-[820px]">
            <div className="bg-white border border-stroke1 rounded-2xl overflow-hidden">
              <dl className="divide-y divide-stroke1 m-0">
                {[
                  { label: "会社名", value: "Tally Group合同会社" },
