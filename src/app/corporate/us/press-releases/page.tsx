...
const newsItems = [
  {
    ...
    href: "/corporate/us/press-releases/skipping-stone-acquisition",
    image: "/us/SS Acquisition PR Image.png",
  ...
  return (
    <>
      <CorporatePageHero
        ...
        title="News"
        lede="Press releases and announcements from Tally+ United States."
      />
