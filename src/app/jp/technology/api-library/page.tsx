...
const docItems = [
  ...
  {
    strong: "Limits",
    text: "documented rate limits and burst behaviour; bulk endpoints favour asynchronous completion where payloads are large (for example MDM interval backfills).",
  },
];
...
const integrationCards = [
  {
    ...
    body: "Subscribe to market message outcomes or webhook callbacks when gateway workflows complete—supporting reconciliation with AEMO, OCCTO‑aligned flows, or other operators depending on region.",
  },
  {
    icon: "person_add",
    title: "Idempotent customer & enrolment POST",
...
export default function JPApiLibraryPage() {
  return (
    <>
      <TechHero
        eyebrow="テクノロジー / API ライブラリ"
        title="API Library"
      ...
      >
        ...
        <TechCTARow
          buttons={[
            ...
            { label: "Contact Tally+ Japan", href: "/contact", variant: "secondary" },
          ]}
        />
      </TechSection>
    </>
