    ...
    <>
      ...
      >
        ...
        <section className="relative pt-[24px] pb-[48px] lg:pt-[32px] lg:pb-[64px]">
          <div className="max-w-[1240px] mx-auto px-8">
            <h1 className="text-[28px] lg:text-[48px] font-light leading-[1.2] tracking-[-0.02em] text-navy max-w-[24ch] m-0">
      ...
      <article className="bg-bg2 py-[80px] lg:py-[96px]">
        <div className="max-w-[760px] mx-auto px-8">
          ...
          <div className="space-y-[18px]">
            ...
            <h2 className="text-[22px] lg:text-[28px] font-light leading-[1.25] tracking-[-0.02em] text-navy m-0 mt-[40px] mb-[4px]">
              スキッピングストーンについて
            </h2>
            <p className="text-[17px] leading-[1.75] text-fg1 m-0">
