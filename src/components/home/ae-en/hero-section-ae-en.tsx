...
export function HeroSectionAEEn() {
        ...
        <div className="relative z-10 max-w-[1600px] mx-auto px-8 text-center mt-auto pb-[48px] sm:pb-[64px]">
          ...
          >
            ...
            <p className="mt-[20px] text-[15px] sm:text-[17px] lg:text-[18px] leading-[1.6] text-white/80 max-w-[62ch] mx-auto">
              ...
              Tally+ operations platform delivers AI-powered end-to-end utility
              retail solutions in one modular ecosystem.
            </p>
