...
export function ValuePillarsSectionAEEn() {
  return (
          ...
          {pillars.map((pillar, i) => {
            ...
            return (
              ...
              >
                ...
                >
                  <h3 className="text-[28px] sm:text-[32px] lg:text-[44px] font-light leading-[1.15] tracking-[-0.025em] text-navy mb-[20px] lg:mb-[24px]">
                    {pillar.title}
                  </h3>
                  <p className="text-[16px] sm:text-[17px] lg:text-[18px] leading-[1.65] text-fg2 max-w-[52ch]">
                    {pillar.body}
                  </p>
                </div>
              </motion.div>
