...
export function TestimonialsSectionAEEn() {
  return (
        ...
        >
          <div className="bg-white border border-stroke1 rounded-2xl p-[40px] lg:p-[56px] shadow-[0_4px_24px_rgba(0,0,0,0.04)]">
            ...
            <div className="mb-[28px]">
              <div className="text-[20px] lg:text-[24px] font-bold text-navy leading-[1.3] tracking-[-0.01em]">
                Alinta Energy
              </div>
            ...
            <blockquote className="m-0 p-0 text-[17px] lg:text-[19px] leading-[1.65] text-fg1 tracking-[-0.005em]">
              Glass Vision cut our average handle time by 38 seconds in the
              first month. Agents stopped switching between four tabs to answer
              one bill question. The platform speaks energy out of the box
              &mdash; NMIs, embedded networks, life-support flags. We stopped
              paying consultants to explain our business back to our CRM.
            </blockquote>
