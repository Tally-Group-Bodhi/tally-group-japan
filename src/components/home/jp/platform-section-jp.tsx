...
export function PlatformSectionJP() {
  const href = useMarketingHref();

  return (
    <section id="platform" className="pt-[96px] lg:pt-[120px] pb-0 bg-white">
      <motion.div
          ...
          >
            ...
            >
              ...
              <div className="absolute left-[24px] right-[24px] bottom-[24px] flex flex-col items-start">
                <h3 className="text-white text-[20px] sm:text-[22px] font-semibold leading-[1.35] tracking-[-0.01em] transition-transform duration-300 ease-out group-hover:-translate-y-1">
                  {s.stage}
                </h3>
                <span
